...
insert into public.products(id,name,size,bottles_per_crate,full_crate_price,bottles_returnable,crate_type,bottle_type)
values ('10000000-0000-4000-8000-000000000011','Test Drink','Big',12,12500,true,'test-crate','test-bottle');
...
do $$ declare field text; begin
  ...
  begin
    ...
    values ('10000000-0000-4000-8000-000000000011','Duplicate retry',12,0,false,'test-crate');
  ...
  exception when check_violation then null; end;
  begin
    update public.products set crate_type=' ';
...
insert into public.products(name,size,bottles_per_crate,full_crate_price,bottles_returnable,crate_type)
values ('Updated drink','Big',24,0,false,'other-crate');
...
do $$ declare changed integer; begin
  ...
  begin
    insert into public.products(name,bottles_per_crate,full_crate_price,bottles_returnable,crate_type)
    values ('Intruder',12,0,false,'crate');
...
do $$ begin
  ...
  begin
    insert into public.products(name,bottles_per_crate,full_crate_price,bottles_returnable,crate_type)
    values ('Anonymous',12,0,false,'crate');
