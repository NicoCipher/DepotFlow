...
insert into public.sale_items(sale_id, product_id, product_name, total_bottles, bottles_per_crate, line_total, bottles_returnable, crate_type_id, bottle_type, whole_crates)
values ('30000000-0000-0000-0000-000000000001', '10000000-0000-0000-0000-000000000001', 'Test Drink', 30, 12, 30000, true, 'b3882166-eedd-5c82-a83f-94a760c1b718', 'test-bottle', 2);
do $$
begin
