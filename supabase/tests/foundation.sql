...
insert into public.products(id, name, bottles_per_crate, full_crate_price, bottles_returnable, crate_type, bottle_type)
values ('10000000-0000-0000-0000-000000000001', 'Test Drink', 12, 12000, true, 'test-crate', 'test-bottle');
...
insert into public.sale_items(sale_id, product_id, product_name, total_bottles, bottles_per_crate, line_total, bottles_returnable, crate_type, bottle_type)
values ('30000000-0000-0000-0000-000000000001', '10000000-0000-0000-0000-000000000001', 'Test Drink', 30, 12, 30000, true, 'test-crate', 'test-bottle');
do $$
begin
